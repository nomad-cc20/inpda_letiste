...
import sem_1.relogo.UserLink;
import sem_1.relogo.UserObserver;
import sem_1.relogo.UserPatch;
import sem_1.relogo.UserTurtle;
...
public class SimBuilder implements ContextBuilder {
	...
	public Context build(Context context) {
		...
		RunEnvironment.getInstance().endAt(16200);
